;
;	Small Monitor EKMonitor for ReadBoard 6809 + tinyBasic embedded.
;
;	version:	1.3
;	Created:	2012 September 04	
;	Updated:	2015 February 27
...
;	Change log:
;	----------------------------------------------------------------------------------------------------
;	2015/02/27	-	Fix in SkipSpace about the bug found by SkipSpace "Roland Leurs". Thanks you!
;	----------------------------------------------------------------------------------------------------
...
CMD01				JSR		GETLIN					;	instead use my own ReadString subroutine
...
IN03				LDA	#'?'
					...
					JSR		GETLIN					;	instead use my own ReadString subroutine
...
STRSystemStart		fcc	"\033ERedBoard 6809, EKMonitor by Favard Laurent 2003/2015\015\012\0"
